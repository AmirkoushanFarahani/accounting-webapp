...
export interface EnrollmentPayment { id: UUID; amount: Money; method: "CASH" | "BANK_TRANSFER" | "CHECK" | "INSTALLMENT"; due_date: string | null; tracking_code: string | null; sayad_id: string | null; status: "PENDING" | "PAID" | "BOUNCED" }
export interface Enrollment { id: UUID; subtotal: Money; discount_amount: Money; total_amount: Money; amount_paid: Money; balance_due: Money; status: string; courses: EnrollmentCourse[]; payments: EnrollmentPayment[] }
